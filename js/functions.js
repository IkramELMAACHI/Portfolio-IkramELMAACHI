...
$('#experience #projects-fullstack').on('click', function(e) {
    ...
    $('#experience #blog-native').removeClass('hidden');
    $('#experience #e-commerce').removeClass('hidden');
    $('#experience #google-map').removeClass('hidden');
    $('#experience #frigo-recette').removeClass('hidden');
    $('#experience #clone-insta').removeClass('hidden');
...
$('#experience #projects-frontend').on('click', function(e) {
    ...
    $('#experience .project').addClass('hidden');
    $('#experience #rock-paper').removeClass('hidden');
    $('#experience #speech').removeClass('hidden');
    $('#experience #mole').removeClass('hidden');

    $('#experience #shortener').removeClass('hidden');
    $('#experience #nasa').removeClass('hidden');
